...
const ar = {
  ...
  home: {
    ...
    finalCtaBody:
      "أخبرنا بما تريد تحسينه: طلبات المواعيد، استفسارات المرضى، مطابقة العقارات، استفسارات المركبات، طلبات الخدمة، متابعة العملاء، مسارات واتساب، التطبيقات، لوحات التحكم، أو موقعك.",
  },
  improve: [
    {
      id: "ai-customer-automation",
      title: "أتمتة تواصل العملاء",
      body:
        "نبني مساعدين ومسارات استقبال تجيب عن الأسئلة الروتينية، تجمع بيانات العملاء، تؤهل الطلبات، وتحول الاستفسارات الجادة إلى فريقك.",
      bestFor: [
        "العيادات",
        "شركات العقارات",
    ...
    {
      id: "whatsapp-lead-automation",
      title: "مسارات واتساب والعملاء",
      body:
        "تعتمد كثير من شركات MENA على واتساب. نساعدك على تنظيم المحادثات، جمع المعلومات الصحيحة، تأهيل العملاء، وتوجيه الاستفسار للشخص المناسب.",
      examples: [
        "مسار استفسار واتساب",
        "جمع طلبات المواعيد",
    ...
    },
    {
      ...
      body:
        "نبني لوحات تعرض الاستفسارات وطلبات المواعيد والعملاء العقاريين والحالة والتحويل والمتابعة في مكان واحد.",
      examples: [
  ...
  industries: [
    ...
    },
    {
      ...
      body:
        "تحتاج فرق الخدمات الميدانية إلى طلبات خدمة أوضح، تفاصيل عروض، جدولة، تعيين فرق، حالة عمل، ومتابعة.",
      systems: [
        "فرز طلبات الخدمة",
        "مسار استقبال العروض",
        "تعيين فني أو فريق",
  ...
  useCases: [
    ...
    {
      id: "real-estate-lead-follow-up",
      title: "تأهيل ومتابعة عملاء العقارات",
      problem:
        "يستقبل الوكلاء عملاء كثيرين بتفاصيل ناقصة ويصعب تتبع من يحتاج الاتصال أو الرسالة التالية.",
      solution:
        "يتتبع نظام التأهيل والمتابعة الميزانية والمنطقة والنوع والاستعجال والمصدر والحالة والخطوة التالية.",
      result: [
        "يرتب الوكلاء العملاء الجادين",
        "تصبح المتابعة ثابتة",
  ...
  contact: {
    ...
    heroBody:
      "سواء كنت تحتاج استفسارات أوضح، استقبال مواعيد، متابعة عملاء عقارات، مسارات واتساب، موقعاً، تطبيقاً، لوحة تحكم، أو نظاماً داخلياً، يمكننا مساعدتك على تحديد أبسط نسخة مفيدة.",
    cta:
