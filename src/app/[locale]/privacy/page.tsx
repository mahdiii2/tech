...
const copy = {
  ...
  ar: {
    ...
    sections: [
      ...
      {
        title: "كيف نستخدمها",
        body: "نستخدم هذه المعلومات للرد على طلبك، فهم احتياجات عملك، إعداد توصيات، وتقديم خدمات الذكاء الاصطناعي، الأتمتة، المواقع، التطبيقات، لوحات التحكم، الدعم أو الاستضافة.",
      },
      {
        title: "أدوات خارجية",
